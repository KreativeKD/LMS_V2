...
export const registerStudent = async (data) => {
  ...
  if (!response.ok) {
    ...
    const error = new Error(
      detailsText || responseData?.error || "Registration failed",
    );
...
export const createCourse = async (courseData) => {
  ...
  if (!response.ok) {
    ...
    const detailsText = Array.isArray(data?.details)
      ...
      : null;
    const error = new Error(
      detailsText || data?.error || "Failed to create course",
    );
    error.response = { status: response.status, data };
    throw error;
  }
...
export const updateCourse = async (courseId, courseData) => {
  ...
  if (!response.ok) {
    ...
    const detailsText = Array.isArray(data?.details)
      ...
      : null;
    const error = new Error(
      detailsText || data?.error || "Failed to update course",
    );
    error.response = { status: response.status, data };
    throw error;
  }
...
export const reorderChapters = async (courseId, chapterIds) => {
  const response = await fetch(
    `${API_URL}/courses/${courseId}/chapters/reorder`,
    {
      method: "PATCH",
      headers: getHeaders(),
...
export const addUnit = async (chapterId, unitData) => {
  const response = await fetch(
    `${API_URL}/courses/chapters/${chapterId}/units`,
    {
      method: "POST",
      headers: getHeaders(),
...
export const reorderUnits = async (chapterId, unitIds) => {
  const response = await fetch(
    `${API_URL}/courses/chapters/${chapterId}/units/reorder`,
    {
      method: "PATCH",
      headers: getHeaders(),
...
export const deleteCourseFeedbackById = async (courseId, feedbackId) => {
  const response = await fetch(
    `${API_URL}/courses/${courseId}/testimonials/${feedbackId}`,
    {
      method: "DELETE",
      headers: getHeaders(),
    },
...
export const approveEnrollment = async (courseId, studentId, action) => {
  const response = await fetch(
    `${API_URL}/courses/${courseId}/approve-enrollment`,
    {
      method: "POST",
      headers: getHeaders(),
...
export const unassignTeacher = async (courseId, teacherId) => {
  const response = await fetch(
    `${API_URL}/courses/${courseId}/assigned-teachers/${teacherId}`,
    {
      method: "DELETE",
      headers: getHeaders(),
    },
...
export const updateMyInstructorProfile = async (data) => {
  ...
  if (!response.ok) {
    const error = new Error(
      responseData?.error || "Failed to update instructor profile",
    );
...
export const likeUnit = async (courseId, unitId) => {
  const response = await fetch(
    `${API_URL}/courses/${courseId}/unit/${unitId}/like`,
    {
      method: "POST",
      headers: getHeaders(),
    },
...
export const getLikes = async (courseId, unitId) => {
  const response = await fetch(
    `${API_URL}/courses/${courseId}/unit/${unitId}/likes`,
    {
      headers: getHeaders(),
    },
  );
...
export const fetchPublicAnnouncements = async (limit = 8) => {
  const response = await fetch(
    `${API_URL}/public/announcements?limit=${limit}`,
  );
...
export const approveAdminTestimonial = async (testimonialId) => {
  const response = await fetch(
    `${API_URL}/public/admin/testimonials/${testimonialId}/approve`,
    {
      method: "PATCH",
      headers: getHeaders(),
    },
...
export const rejectAdminTestimonial = async (testimonialId) => {
  const response = await fetch(
    `${API_URL}/public/admin/testimonials/${testimonialId}/reject`,
    {
      method: "PATCH",
      headers: getHeaders(),
    },
...
export const deleteAdminTestimonial = async (testimonialId) => {
  const response = await fetch(
    `${API_URL}/public/admin/testimonials/${testimonialId}`,
    {
      method: "DELETE",
      headers: getHeaders(),
    },
...
export const fetchUnitComments = async (courseId, unitId) => {
  const response = await fetch(
    `${API_URL}/courses/${courseId}/unit/${unitId}/comments`,
    {
      headers: getHeaders(),
    },
  );
...
export const updateUnitComment = async (courseId, unitId, commentId, text) => {
  const response = await fetch(
    `${API_URL}/courses/${courseId}/unit/${unitId}/comments/${commentId}`,
    {
      method: "PATCH",
      headers: getHeaders(),
      body: JSON.stringify({ text }),
...
export const fetchPasswordResetRequests = async () => {
  const response = await fetch(
    `${API_URL}/auth/admin/password-reset-requests`,
    {
      headers: getHeaders(),
    },
  );
...
export const approvePasswordResetRequest = async (requestId) => {
  const response = await fetch(
    `${API_URL}/auth/admin/password-reset-requests/${requestId}/approve`,
    {
      method: "PATCH",
      headers: getHeaders(),
    },
...
export const rejectPasswordResetRequest = async (requestId) => {
  const response = await fetch(
    `${API_URL}/auth/admin/password-reset-requests/${requestId}/reject`,
    {
      method: "PATCH",
      headers: getHeaders(),
    },
...
export const deletePasswordResetRequest = async (requestId) => {
  const response = await fetch(
    `${API_URL}/auth/admin/password-reset-requests/${requestId}`,
    {
      method: "DELETE",
      headers: getHeaders(),
    },
